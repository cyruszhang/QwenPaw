...
const en = {
  ...
  // Settlement panel
  "settlement.aria": "Knowledge settlement cards",
  "settlement.title": "Knowledge to confirm",
  "settlement.subtitle":
    "Confirmed cards are written back to the knowledge base",
  "settlement.confirm": "Confirm",
  "settlement.dismiss": "Dismiss",
  "settlement.type.metricCaliber": "Metric caliber",
  "settlement.type.dimensionDef": "Dimension definition",
  "settlement.type.columnMeaning": "Column meaning",
  "settlement.type.datasetUsage": "Dataset usage",

  // Cron jobs page
  "cron.aria": "Scheduled analyses",
  "cron.eyebrow": "Automations",
  "cron.title": "Scheduled analyses",
  "cron.description":
    "Run analyses unattended on a schedule; results land in the linked session.",
  "cron.newJob": "New job",
  "cron.loading": "Loading jobs…",
  "cron.empty": "No scheduled analyses yet.",
  "cron.jobMeta": "Data source {datasource} · {status}",
  ...
  "cron.toast.created": "Scheduled job created",
  "cron.toast.ran": "Job started",
  "cron.form.name": "Name",
  "cron.form.namePlaceholder": "Daily GAAP briefing",
  "cron.form.message": "Analysis question",
  "cron.form.messagePlaceholder":
    "Summarize yesterday's key metric movements",
  "cron.form.datasource": "Data source",
  "cron.form.datasourcePlaceholder": "Select a data source",
  "cron.form.schedule": "Schedule (cron)",
  "cron.form.scheduleHint": "min hour day month weekday, e.g. 0 9 * * *",
  "cron.form.create": "Create job",
  "cron.form.creating": "Creating…",
  "cron.form.cancel": "Close",
  ...
  "segments.execution": "Execution",
  "segments.conclusion": "Conclusion",
  "segments.artifacts": "Key artifacts",
...
const zh: Record<StringKey, string> = {
  ...
  "settlement.aria": "知识沉淀卡片",
  "settlement.title": "待确认的知识",
  "settlement.subtitle": "确认后的卡片会写回知识库",
  "settlement.confirm": "确认",
  "settlement.dismiss": "忽略",
  "settlement.type.metricCaliber": "指标口径",
  "settlement.type.dimensionDef": "维度定义",
  "settlement.type.columnMeaning": "字段含义",
  "settlement.type.datasetUsage": "数据集用途",

  "cron.aria": "定时分析",
  "cron.eyebrow": "自动化",
  "cron.title": "定时分析",
  "cron.description": "按计划自动运行分析，结果写入关联会话。",
  "cron.newJob": "新建任务",
  "cron.loading": "加载中…",
  "cron.empty": "还没有定时分析任务。",
  "cron.jobMeta": "数据源 {datasource} · {status}",
  ...
  "cron.toast.created": "定时任务已创建",
  "cron.toast.ran": "任务已启动",
  "cron.form.name": "名称",
  "cron.form.namePlaceholder": "每日 GAAP 简报",
  "cron.form.message": "分析问题",
  "cron.form.messagePlaceholder": "总结昨天的关键指标变化",
  "cron.form.datasource": "数据源",
  "cron.form.datasourcePlaceholder": "请选择数据源",
  "cron.form.schedule": "调度（cron 表达式）",
  "cron.form.scheduleHint": "分 时 日 月 周，例如 0 9 * * *",
  "cron.form.create": "创建任务",
  "cron.form.creating": "创建中…",
  "cron.form.cancel": "收起",
  ...
  "segments.input": "输入",
  "segments.execution": "执行",
  "segments.conclusion": "结论",
  "segments.artifacts": "关键产物",
