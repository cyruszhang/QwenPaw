...
class SeedanceToolPlugin:
    ...
    def register(self, api: PluginApi):
        ...
        api.register_tool(
            ...
            description="Generate a video from a text prompt with Seedance 2.0",  # noqa: E501
            icon="🌱",
        )
        api.register_tool(
            tool_name="image_to_video_seedance",
            tool_func=tool.image_to_video_seedance,
            description="Generate a video from a starting image with Seedance 2.0",  # noqa: E501
            icon="🌱",
        )
        api.register_tool(
            ...
            description=(
                "Generate a video with multi-modal references using "
                "Seedance 2.0"
            ),
            icon="🌱",
        )
